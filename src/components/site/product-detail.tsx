    ...
    <div className="bg-neutral-950">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-6 pb-20 pt-40 text-center">
          ...
          <Link
            href="/contact"
            className="mt-10 inline-flex items-center gap-2 rounded-full bg-brand px-8 py-4 text-base font-semibold text-white shadow-2xl transition hover:bg-brand-strong"
          >
      ...
      <section className="border-y border-white/10 bg-gradient-to-r from-brand/20 to-transparent py-16">
        <div className="mx-auto flex max-w-4xl flex-col items-center gap-6 px-6 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 rounded-full bg-brand px-8 py-4 font-semibold text-white transition hover:bg-brand-strong"
          >
