...
export const metadata: Metadata = {
  title: "Wholesale Supply — Abraco Energies",
  description:
  ...
  return (
    <main className="bg-neutral-950">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-6 pb-20 pt-40 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/60">
            ...
            Accredited Providers, and installers across Australia — making energy
            efficiency accessible, affordable, and hassle-free.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {PRODUCTS.map((p) => (
              <div
                key={p}
                className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.04] p-5 text-white/80"
              >
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6">
          <h2 className="text-3xl font-semibold text-white">Why partner with us</h2>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-md text-white/60">
              ...
              Abraco Energies is your trusted supply partner. Open a trade
